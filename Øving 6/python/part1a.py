...
p = np.array([-179, 270, 100])*np.pi/180

#
# Task: Call gauss_newton
#
p=gauss_newton(resfun, p, step_size=0.9, num_steps=10000000, xtol=0.01, ftol=None, print_progress=False, finite_difference_epsilon=1e-6)
